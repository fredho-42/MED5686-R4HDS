...
\includegraphics[width=3.125in,height=\textheight,keepaspectratio]{_main_files/images/00-GlaLogo.png}
...
{\centering \includegraphics[width=0.5\linewidth]{images/04-ggplotcheatsheet} 
...
{\centering \includegraphics[width=0.95\linewidth]{images/01-help_sum} 
...
{\centering \includegraphics[width=0.8\linewidth]{images/01-dplyr_vignettes} 
...
{\centering \includegraphics[width=0.8\linewidth]{images/01-dplyr_CRAN} 
...
{\centering \includegraphics[width=1\linewidth]{images/02-RStudio screenshot - first} 
...
{\centering \includegraphics[width=1\linewidth]{images/02-RStudio screenshot} 
...
{\centering \includegraphics[width=0.75\linewidth]{images/02-R_project_1} 
...
{\centering \includegraphics[width=0.75\linewidth]{images/02-R_project_2} 
...
## Ncells 2279264 121.8    4155598  222  4155598  222
## Vcells 4002273  30.6    8388608   64  6674120   51
\end{verbatim}
...
{\centering \includegraphics[width=0.95\linewidth]{images/03-ObjectDiagram} 
...
{\centering \includegraphics[width=0.7\linewidth]{images/03-Labs_vec} 
...
\begin{figure}
\includegraphics[width=0.49\linewidth]{images/03-Variables} \includegraphics[width=0.49\linewidth]{images/03-Observations} \caption{A visual representation of tabular tidy data, where columns contain one variable and rows contain one observation or case.}\label{fig:dt-description}
\end{figure}
...
{\centering \includegraphics[width=0.8\linewidth]{images/03-Statistical data types} 
...
\begin{figure}
\includegraphics[width=0.49\linewidth]{images/03-WideData} \includegraphics[width=0.49\linewidth]{images/03-LongData} \caption{A visual representation of wide versus long data, in wide data, each row contains multiple measurements, versus in long data, where each row contains one measurement.}\label{fig:wide-v-long}
\end{figure}
...
{\centering \includegraphics[width=0.8\linewidth]{images/03-Labs_DF} 
...
{\centering \includegraphics[width=0.5\linewidth]{images/03-ifElse} 
...
{\centering \includegraphics[width=1\linewidth]{images/03-joins} 
...
\begin{center}\includegraphics[width=0.5\linewidth]{images/04-ggplot_Logo} \end{center}
...
\begin{verbatim}
##           used  (Mb) gc trigger  (Mb) max used (Mb)
## Ncells 2417048 129.1    4155598 222.0  4155598  222
## Vcells 4308609  32.9   10146329  77.5  8388583   64
\end{verbatim}
...
\pandocbounded{\includegraphics[keepaspectratio]{_main_files/_main_files/figure-latex/unnamed-chunk-97-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{_main_files/_main_files/figure-latex/unnamed-chunk-99-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{_main_files/_main_files/figure-latex/unnamed-chunk-100-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{_main_files/_main_files/figure-latex/unnamed-chunk-101-1.pdf}}

We can see that all points have turned orange, regardless of the underlying species data in this case.

\begin{figure}

{\centering \includegraphics[width=0.4\linewidth]{images/04-points-symbols} 
...
\pandocbounded{\includegraphics[keepaspectratio]{_main_files/_main_files/figure-latex/unnamed-chunk-102-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{_main_files/_main_files/figure-latex/unnamed-chunk-104-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{_main_files/_main_files/figure-latex/unnamed-chunk-105-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{_main_files/_main_files/figure-latex/unnamed-chunk-106-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{_main_files/_main_files/figure-latex/unnamed-chunk-107-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{_main_files/_main_files/figure-latex/unnamed-chunk-108-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{_main_files/_main_files/figure-latex/unnamed-chunk-109-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{_main_files/_main_files/figure-latex/unnamed-chunk-110-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{_main_files/_main_files/figure-latex/unnamed-chunk-111-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{_main_files/_main_files/figure-latex/unnamed-chunk-112-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{_main_files/_main_files/figure-latex/unnamed-chunk-113-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{_main_files/_main_files/figure-latex/unnamed-chunk-114-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{_main_files/_main_files/figure-latex/unnamed-chunk-115-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{_main_files/_main_files/figure-latex/unnamed-chunk-116-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{_main_files/_main_files/figure-latex/unnamed-chunk-118-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{_main_files/_main_files/figure-latex/unnamed-chunk-119-1.pdf}}
...
\begin{center}\includegraphics[width=0.23\linewidth]{images/04-palmerpenguins} \end{center}
...
{\centering \includegraphics[width=1\linewidth]{images/04-Palmerspenguins} 
...
\pandocbounded{\includegraphics[keepaspectratio]{_main_files/_main_files/figure-latex/unnamed-chunk-126-1.pdf}}
...
\begin{verbatim}
##           used  (Mb) gc trigger  (Mb) max used (Mb)
## Ncells 2782749 148.7    4155598 222.0  4155598  222
## Vcells 4922966  37.6   10146329  77.5  8388583   64
\end{verbatim}
...
\pandocbounded{\includegraphics[keepaspectratio]{_main_files/_main_files/figure-latex/unnamed-chunk-149-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{_main_files/_main_files/figure-latex/unnamed-chunk-153-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{_main_files/_main_files/figure-latex/plot-km-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{_main_files/_main_files/figure-latex/plot-km-groups-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{_main_files/_main_files/figure-latex/plot-km-groups-2.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{_main_files/_main_files/figure-latex/schoenfeld-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{_main_files/_main_files/figure-latex/mod-fp-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{_main_files/_main_files/figure-latex/mod-spline-1.pdf}}

\chapter{Causal Inference: Mediation and Instrumental Variables}\label{ch-7}

In previous chapters, we focused on establishing associations between variables. However, in health data science, we often want to understand the \emph{causal} mechanisms driving these associations. This chapter introduces two advanced causal inference techniques: \textbf{mediation analysis} (to understand \emph{how} an exposure affects an outcome) and \textbf{instrumental variable variables} (to estimate causal effects in the presence of unmeasured confounding).

The mediation analysis will be based on the \texttt{CMAverse} package which is not available from the \textbf{CRAN} (the official repository for R packages) but could be installed from \textbf{Github} (a commonly used developer maintained respository) using the following command. You may not have the \texttt{devtool} installed on your computer yet. If that's the case, please install it first.
...
In the mediation analysis, we will still be focusing on the Understanding Society longitudinal data. The primary hypothesis was to examine whether \textbf{\hyperref[acronyms_PW]{physical well-being (PW)}} (mediator) could be a mechanism between \textbf{\hyperref[acronyms_BMI]{BMI}} (exposure) and \textbf{\hyperref[acronyms_MW]{MW}} (outcome).

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# 1. Raw data import and reshaping}
\NormalTok{dat }\OtherTok{\textless{}{-}} \FunctionTok{read\_csv}\NormalTok{(}\StringTok{\textquotesingle{}./data/06{-}understanding\_soc.csv\textquotesingle{}}\NormalTok{) }
\end{Highlighting}
\end{Shaded}
...
As usual, it is essential to inspect the descriptive statistics before conducting more complex models. We use the \texttt{statistic} argument to specify that we want the mean and \textbf{\hyperref[acronyms_SD]{SD}} for all continuous variables, and the \texttt{digits} argument to round the results neatly.
...
\toprule
\textbf{Characteristic} & \textbf{N = 11,447}\textsuperscript{\textit{1}} \\ 
\midrule\addlinespace[2.5pt]
age & 49.1 (14.9) \\ 
sex &  \\ 
    Female & 6,532 (57.1\%) \\ 
...
Before looking for a mediator, we establish the baseline association. Here, we model mental wellbeing at Wave 9 (\texttt{mw9}) based on baseline \textbf{\hyperref[acronyms_BMI]{BMI}} (\texttt{bmi}), adjusting for sociodemographic confounders and baseline wellbeing.
...
\subsection{Difference Method for Mediation}\label{difference-method-for-mediation}

The simplest way to check for mediation is the \textbf{``difference method''}. It is simply done by adding the candidate mediator (\hyperref[acronyms_PW]{PW} at Wave 5, \texttt{pw5}) into the regression model. If \hyperref[acronyms_PW]{PW} mediates the relationship between \textbf{\hyperref[acronyms_BMI]{BMI}} and \hyperref[acronyms_MW]{MW}, the coefficient for \textbf{\hyperref[acronyms_BMI]{BMI}} should attenuate noticeably in the new model compared with the base model.

The codes below fit a second linear model (\texttt{m1}) that includes \texttt{pw5}. We then use \texttt{gtsummary::tbl\_merge()} to put both models side-by-side for easy visual comparison. Minimal differences between the \textbf{\hyperref[acronyms_BMI]{BMI}} coefficients across the two models suggest minimal mediation.
...
\begin{tabular*}{\linewidth}{@{\extracolsep{\fill}}lcccccc}
\toprule
 & \multicolumn{3}{c}{{Not adjusted for PW}} & \multicolumn{3}{c}{{Adjusted for PW}} \\ 
\cmidrule(lr){2-4} \cmidrule(lr){5-7}
...
The Sobel test is a traditional statistical test to determine if the indirect effect is significantly different from zero. The codes below use \texttt{bda::mediation.test(mediator,\ exposure,\ outcome)} to conduct the Sobel test. \emph{Warning:} This test is rudimentary and does not adjust for any confounders. It is not recommended for observational health data unless you are absolutely certain no confounding exists.
...
## z.value -7.584483e+00 -7.579314e+00 -7.589662e+00
## p.value  3.338162e-14  3.473873e-14  3.207406e-14
\end{verbatim}

\subsection{Parametric G-Formula}\label{parametric-g-formula}
...
2. These regression models do not handle \textbf{exposure-induced mediator-outcome confounder}. See figure below. E is exposure; O is outcome; A is mediator of interest. B is also a mediator between E and O, but confounds the relationship between M and O. Regression difference methods cannot address the influence of B.

\begin{center}\includegraphics[width=0.5\linewidth]{images/07-dag1} \end{center}

Modern causal inference relies on more robust methods, such as the parametric g-formula (also known as g-computation), which can handle complex confounding scenarios (including interactions between the exposure and the meditor). In R, we use the \texttt{cmest()} function from the \texttt{CMAverse} package.

\subsubsection{Without Exposure-Induced Confounders}\label{without-exposure-induced-confounders}

The \texttt{cmest()} function is quite complex in that it does not use the formula for models, and a larger number of input is required to get it to work. Below breaks down the input:

\begin{itemize}
\tightlist
\item
  \texttt{model} specify the models to be run. We will need gformula here as it can address exposure-induced mediator-outcome confounder.
\item
  \texttt{mreg} and \texttt{yreg}: Specify the regression types for the mediator and outcome models (e.g., `linear' or `logistic').
\item
  \texttt{exposure}, \texttt{mediator} and \texttt{outcome} are self-explanatory - just the variable names for these causal roles.
\item
  \texttt{basec} is the baseline confounders.
\item
  \texttt{a} is the intervention value and \texttt{astar} is the reference value. While the exposure variable is numeric, cmest needs these two to caulate the total, direct and indirect effect. The total effect for this code below is, therefore, comparing 26.69 (mean in this sample) with the overweight cut-off (25).
\item
  \texttt{mval} is the reference value for the mediator, similar to what \texttt{astar} does.
\item
  \texttt{mreg} and \texttt{yreg} indicate the regression you want to use for the simulation. It usually depends on the variable type of the mediator and the outcome.
\item
  \texttt{EMint=FALSE}: Specifies that we are not evaluating exposure-mediator interaction.
\end{itemize}
...
## cde  -0.071117  0.032166 -0.129036  -0.001  0.04 *
## pnde -0.071117  0.032166 -0.129036  -0.001  0.04 *
## tnde -0.071117  0.032166 -0.129036  -0.001  0.04 *
## pnie -0.002807  0.003196 -0.008816   0.003  0.42  
## tnie -0.002807  0.003196 -0.008816   0.003  0.42  
## te   -0.073924  0.031856 -0.129855  -0.007  0.03 *
## pm    0.037973  0.262579 -0.038727   0.355  0.43  
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
...
Suppose if we think \hyperref[acronyms_MW]{MW} at wave 5 could confound the relationship between \hyperref[acronyms_PW]{PW} at wave 5 and \hyperref[acronyms_MW]{MW} at wave 10:

\begin{center}\includegraphics[width=0.5\linewidth]{images/07-dag2} \end{center}

This can be modelled by adding one more argument to the \texttt{cmest()} function - the \texttt{postc}. It is to specify the intermediate (post-exposure) confounder (\texttt{mw5}). We also must tell the function how to model this intermediate variable using the \texttt{postcreg} argument (here, as a `linear' regression).
...
##  
##        Estimate Std.error   95% CIL 95% CIU  P.val    
## cde   -0.049141  0.029919 -0.114869   0.005   0.08 .  
## rpnde -0.049141  0.029919 -0.114869   0.005   0.08 .  
## rtnde -0.049141  0.029919 -0.114869   0.005   0.08 .  
## rpnie -0.024783  0.003927 -0.032706  -0.017 <2e-16 ***
## rtnie -0.024783  0.003927 -0.032706  -0.017 <2e-16 ***
## te    -0.073924  0.030192 -0.140045  -0.020   0.01 ** 
## pm     0.335244  0.315159  0.169412   1.247   0.01 ** 
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
...
The indirect effect becomes significant and was estimated to mediate about 1/3 of the total effect. This contradicts with the previous results, and which one is more accurate would depend on how likely \hyperref[acronyms_MW]{MW} at wave 5 is a confounder.
...
\tightlist
\item
  \textbf{ITT Analysis:} We analyze patients based purely on the group they were randomized to, regardless of whether they actually attended the exercise sessions. This is statistically safe from confounding but usually underestimates the true biological effect of the intervention.
\item
  \textbf{Per Protocol (PP) Analysis:} We analyze patients based on their actual attendance. While this looks at the ``true'' intervention, it is heavily confounded (e.g., highly motivated people might attend more \emph{and} have naturally lower stress).
\end{enumerate}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dat\_iv }\OtherTok{\textless{}{-}} \FunctionTok{read\_csv}\NormalTok{(}\StringTok{\textquotesingle{}./data/07{-}iv.csv\textquotesingle{}}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
## F-statistic: 40.31 on 1 and 345 DF,  p-value: 6.818e-10
\end{verbatim}
...
IV analysis extracts the variation in \texttt{attendance} that is purely driven by the randomization \texttt{group} (the instrument), effectively purging the confounding noise from the model.

We use the \texttt{ivreg()} function from the \texttt{AER} package. The formula \texttt{stress\ \textasciitilde{}\ attendance\ \textbar{}\ group} is read as: model the outcome (\texttt{stress}) against the exposure (\texttt{attendance}), using the variable after the pipe (\texttt{group}) as the instrument.
...
## Wald test: 20.68 on 1 and 345 DF,  p-value: 7.532e-06
\end{verbatim}
...
\item[\protect\phantomsection\label{acronyms_PW}{PW}]
physical well-being
